 ...
 * Agent so that other agents can dynamically discover it. In this case in particular we register a "Weather-forecast"
 * service for Italy. The name of this service is specified as a command line argument.
 *
...
public class DFRegisterAgent extends Agent {
  ...
  protected void setup() {
    ...
    System.out.println(
        "Agent " + getLocalName() + " registering service \"" + serviceName + "\" of type \"weather-forecast\"");
    try {
