...
public class EngagerAgent extends Agent {
  ...
  class HandleEnganementQueriesBehaviour extends SimpleAchieveREResponder {
    ...
    /**
     * Constructor for the <code>HandleEnganementQueriesBehaviour</code> class.
     *
  ...
  /**
   * This behaviour handles a single engagement action that has been requested following the FIPA-Request protocol
   */
  class HandleEngageBehaviour extends SimpleAchieveREResponder {
     ...
     *
     * @param myAgent    The agent owning this behaviour
     * @param requestMsg The ACL message by means of which the engagement action has been requested
     */
