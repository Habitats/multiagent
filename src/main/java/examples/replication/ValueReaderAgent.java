...
public class ValueReaderAgent extends Agent {
  ...
  /**
   * Inner class PeriodicValueReader This is a behaviour that periodically retrieve the value from the value provider
   * agent and prints it in the standard output
   */
