...
/**
 * This example shows how to create a custom <code>MessageTemplate</code>. In this case we define a template matching
 * only REQUEST messages where the ontology starts with "X".
 *
...
public class CustomTemplateAgent extends Agent {
  ...
  private MessageTemplate
      template =
      MessageTemplate
          .and(MessageTemplate.MatchPerformative(ACLMessage.REQUEST), new MessageTemplate(new MatchXOntology()));
