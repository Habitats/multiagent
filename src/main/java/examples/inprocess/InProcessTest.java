...
/**
 * This class is an example of how you can embed JADE runtime environment within your applications.
 *
...
public class InProcessTest {
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      AgentController
          custom =
          mc.createNewAgent("customAgent", CustomAgent.class.getName(), new Object[]{startUpLatch});
      custom.start();
